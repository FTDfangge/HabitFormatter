...
public class DakaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isDaka=intent.getStringExtra(DakaActivity.EXTRA_MESSAGE1);
        msgFromDaka=intent.getStringExtra(DakaActivity.EXTRA_MESSAGE2);
            ...
            checkBox1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (checkBox1.isChecked()){
                        ...
                        new AlertDialog.Builder(DakaActivity2.this)
        ...
        btn_record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DakaActivity2.this,Record.class);
        ...
        dakaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isDaka.equals("T")) {
                    Intent intent1 = new Intent(DakaActivity2.this, DakaActivity.class);
                    String msg = msgg;
